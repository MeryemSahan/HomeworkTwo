...
```{r}
january <- as.Date("2023-01-01") : as.Date("2023-01-31") 
mins_in_jan <- length(january) * 24 * 60
mins_in_jan <- length(january) * 24 * 60
cat("The total number of minutes in January is ", mins_in_jan, ".")
...
cat("The wizards are: ", paste(wizards, collapse = ", "), "\n")
cat("Their rankings are: ", paste(ranking, collapse = ", "))
...
```{r}
wizards <- c("Harry", "Ron", "Fred", "George", "Sirius")
cat("The second wizard is:", wizards[2])
...
cat("The updated wizards vector is:", wizards)
...
wizards <- c(Harry = "Lead", Ron = "Friend", Hermione = "Friend", Ginny = "Love Interest", Malfoy = "Rival")

cat("The following are the main characters in the Harry Potter series:\n\n")
cat(paste("• ", names(wizards), ": ", wizards, "\n", sep = ""), sep = "")
...
cat(paste0("Mean score: ", mean_score, "\n"))
cat(paste0("Median score: ", median_score, "\n"))
cat(paste0("Range of scores: ", range_score[1], " - ", range_score[2], "\n"))
